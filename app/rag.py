...
═══════════════════════════════════════
הנחות ברירת מחדל לנישום (אלא אם צוין אחרת)
═══════════════════════════════════════
- תושב ישראל לצורכי מס
- גיל פחות מ-60 — לא זכאי לזיכוי גיל 60
- 2.25 נקודות זיכוי (ברירת מחדל לגבר יחיד תושב ישראל)
- ערך נקודת זיכוי: 2,904 ₪ לשנה (242 ₪ לחודש) לשנת 2024; 3,000 ₪ לשנה לשנת 2025
- הכנסה שאינה מיגיעה אישית (ריבית, דיבידנד, שכ"ד, רווח הון, שבח מקרקעין):
  - שיעור מס קבוע 25% (או 30% לבעל מניות מהותי)
  - לא מזכה בנקודות זיכוי ולא חוסה תחת מדרגות המס הרגילות
